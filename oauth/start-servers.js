...
const colorsServer = spawnNode('colors-resource/resources-server.js', 'Colors Server', BRIGHT_GREEN)
const languagesServer = spawnNode('languages-resource/resources-server.js', 'Languages Server', BRIGHT_MAGENTA)
const librariesServer = spawnNode('libraries-resource/resources-server.js', 'Libraries Server', BRIGHT_CYAN)
const personalitiesServer = spawnNode('personalities-resource/resources-server.js', 'Personalities Server', BRIGHT_BLUE)
